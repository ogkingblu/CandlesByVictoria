    ...
    <section class="overflow-hidden">
        <div class="container px-5 pb-24 pt-12 mb-12 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-col md:flex-row">
            <img alt="Large image of the selected candle" class="lg:w-1/2 w-full lg:h-auto h-full object-cover object-center rounded border-2 border-rosewood" src="./img/candles-gingerbread.png">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h1 class="text-4xl text-rosewood font-cabin font-medium mb-3">Gingerbread</h1>
              <div class="flex mb-4">
              ...
              <div class="flex">
                <span class="font-cabin font-medium text-2xl text-rosewood">$29.99</span>
                <a class="hidden add-cart"></a>
                <a class="hidden add-cart"></a>
                <button class="flex ml-auto border-2 border-rosewood text-rosewood font-cabin rounded-sm py-2 px-6 focus:outline-none hover:bg-vermilion hover:text-black hover:border-vermilion add-cart cart3">Add to cart</button>
              </div>
            </div>
